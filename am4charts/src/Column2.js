...
function Column2() {
  useLayoutEffect(() => {
    ...
    chart.data = chartData2.qcChartByPathogenPcData;

    // Create axes
    let categoryAxis = chart.xAxes.push(new am4charts.CategoryAxis());
    categoryAxis.dataFields.category = "pathogenName";
    ...
    series.dataFields.categoryX = "pathogenName";
    series.dataFields.valueY = "positiveCount";
